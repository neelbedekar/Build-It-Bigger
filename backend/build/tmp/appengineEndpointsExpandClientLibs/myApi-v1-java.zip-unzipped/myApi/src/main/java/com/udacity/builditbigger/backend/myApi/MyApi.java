...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokeproject-1052.appspot.com/_ah/api/";
  ...
  public class FetchJoke extends MyApiRequest<com.udacity.builditbigger.backend.myApi.model.MyBean> {
     ...
     */
    protected FetchJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.udacity.builditbigger.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.udacity.builditbigger.backend.myApi.model.MyBean> {
